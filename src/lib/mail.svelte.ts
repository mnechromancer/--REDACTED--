...
export const MAILBOX: MailMessage[] = [
  {
    ...
    body: [
      ...
      'at 0400 daily. At 1600 it is erased. So is everything written about it — cards, pads,',
      'chalk, the works. Do not spend the afternoon making notes; the afternoon does not keep.',
      '',
